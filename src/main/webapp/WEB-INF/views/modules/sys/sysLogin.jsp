...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login"
		...
		<div id="themeSwitch" class="dropdown">
			<td><a href="${ctx}/sys/user/register">点击注册</a></td> <a
				class="dropdown-toggle" data-toggle="dropdown" href="#">${fns:getDictLabel(cookie.theme.value,'theme','默认主题')}<b
				class="caret"></b></a>
	...
	<div class="footer">
		Copyright &copy; ${fns:getConfig('copyrightYear')}酒店管理系統
